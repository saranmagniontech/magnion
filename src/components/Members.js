...
function Members() {
 ...
 <div className="page-container">
      <section className="bg_kjh">
        <div className="card">
          <h2 className="bullet text-center">Lets <span className="clkuh">explore</span> world</h2>
          <div className="row">
            ...
            <div className="col-md-6 col-sm-12">
              <div className="row">
                <div className="col-md-6 col-sm-6">
                  <div className="mb-3">
                    <input type="text" className="form-control" placeholder="No of Adults" />
                  </div>
                </div>
                <div className="col-md-6 col-sm-6">
                  <div className="mb-3">
                    <input type="text" className="form-control" placeholder="No of Kids" />
                  </div>
                </div>
              </div>
            </div>
            <div className="col-md-6">
              <div className="mb-3">
                <input type="date" className="form-control" placeholder="Select Journey Date" />
              </div>
            </div>
            <div className="col-md-6 col-sm-12">
              <div className="mb-3">
                <div className="mb-2">Select Room Type</div>
                <div className="row">
                  <div className="col-md-6 col-sm-6">
                    <input type="radio" id="standard" name="room_type" />
                    <label htmlFor="standard">Standard</label>
                  </div>
                  <div className="col-md-6 col-sm-6">
                    <input type="radio" id="deluxe" name="room_type" />
            ...
            <div className="col-md-6 col-sm-6">
              <div className="mb-3">
                <input type="text" placeholder="Enter Your Destination" className="form-control" />
              </div>
            </div>
            <div className="col-md-6 col-sm-6">
              <div className="mb-3">
            ...
            <div className="col-md-6 col-sm-6">
              <div className="mb-3">
                <select name="circle" id className="form-select">
            ...
            <div className="col-md-6">
              <div className="mb-3">
                <input type="text" placeholder="Enter Membership Id" className="form-control" />
              </div>
            </div>
